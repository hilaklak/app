...
use App\Mail\User\Auth\ResetPasswordEmailRequestMail;
use App\Services\GenerateTokenService;
use App\Services\VerificationEmailService;
use Illuminate\Bus\Queueable;
use Illuminate\Notifications\Notification;

class ResetPasswordEmailRequestNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new ResetPasswordEmailRequestMail($notifiable, $code))
            ->to($notifiable->email);
    }
